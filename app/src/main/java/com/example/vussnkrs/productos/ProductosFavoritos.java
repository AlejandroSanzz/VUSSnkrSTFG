...
public class ProductosFavoritos {
    ...
    public ProductosFavoritos(String SKU, String nombre, String categoria, String descripcion, String talla, String precio, String stock, String nproveedor, String foto){
        this.SKU = SKU;
        this.nombre = nombre;
